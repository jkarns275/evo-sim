...
export namespace evosim
{
    ...
    public:
        ...
        struct param_type
        {
            ...
            // values.
            constexpr explicit param_type(result_type mean, result_type stddev = 1)
        ...
        // stddev = 1.
        constexpr ziggurat_normal_distribution() = default;

        // This constructor creates a normal distribution with given mean and
        // stddev.
        constexpr explicit ziggurat_normal_distribution(result_type mean, result_type stddev = 1)
            : param_{mean, stddev}
        {
        }
        ...
        // parameters.
        constexpr explicit ziggurat_normal_distribution(param_type const& param)
            : param_{param}
        {
        }
        ...
        inline T operator()(URNG& random) const
        {
        ...
        // parameters.
        template<typename URNG>
        inline T operator()(URNG& random, param_type const& param) const
        {
