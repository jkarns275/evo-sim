...
plot("results/modulate_a_eq_b_co.csv", "results/modulate_a_eq_b_no_co.csv", "Convergence Probability vs. Initialization Radius; A = B", "figures/crossover_initialization_a_eq_b.pdf")
plot("results/modulate_a_lt_b_co.csv", "results/modulate_a_lt_b_no_co.csv", "Convergence Probability vs. Initialization Radius; 1.5A = B", "figures/crossover_initialization_a_lt_b.pdf")
